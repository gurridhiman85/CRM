                        ...
                        <div class="col-md-8">
                            <ul class="nav nav-tabs customtab2 mt-2 border-bottom-0 font-14 tab-hash tab-ajax"role="tablist" data-href="campaign/get" data-method="get" data-default-tab="tab_22">
                                ...
                                <li class="nav-item older-version" style="border-bottom: 1px solid #dee2e6;display: none;">
                                    <a class="nav-link" data-row_id="" data-toggle="tab" data-tabid="31" href="#tab_31" role="tab" aria-selected="true">
                                        <span class="hidden-sm-up"></span>
                                ...
                                <li class="nav-item create-new" style="display: none;border-bottom: 1px solid #dee2e6;">
                                    <a class="nav-link" data-toggle="tab" data-shouldblank="yes" data-tabid="30" href="#tab_30" role="tab" aria-selected="true">
                                        <span class="hidden-sm-up"></span>

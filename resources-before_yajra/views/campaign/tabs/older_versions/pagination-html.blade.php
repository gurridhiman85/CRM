...
<script>
    ...
    function pagination_v2(obj, type) {
        ...
        var url = 'campaign/get?show_entries=20&tabid=31&rtype=pagination&page=' + track_page;
    ...
    function load_contents_v2(track_page, type, url) {
        ...
        $.get(url, {'page': track_page, type: type,filters : filtersArr}, function (data) {
            ...
            $("#older_versions_tab").html(data.html); //append data into #results element
            initJS($("#older_versions_tab"));

<div class="dataTables_info " id="taskList_info" role="status" aria-live="polite">
    <div class="ticket-pagination">
        {!! \App\Helpers\Helper::pagination_v2($total_records,$records_per_page,$page,'touch_screen',$position,count($records)) !!}
    </div>
</div>
<script>
    ...
    function pagination_v2(obj, type) {
        ...
        var url = 'lookup/touchesdetails/{!! $contactid !!}?show_entries=20&tabid=21&rtype=pagination&page=' + track_page;
    ...
    function load_contents_v2(track_page, type, url) {
        ...
        $.get(url, {'page': track_page, type: type,filters : filtersArr}, function (data) {
            ...
            $("#touch_screen").html(data.html); //append data into #results element
            //initJS($("#touch_screen"));
            $(".touch-pagination").html(data.pagination_html); //append data into #results element

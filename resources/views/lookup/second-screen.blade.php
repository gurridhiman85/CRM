        ...
        <div class="col-md-4">
            <div class="btn-toolbar pull-right mr-2" role="toolbar" aria-label="Toolbar with button groups">
                <div class="input-group">
                    ...
                    @if(isset($add) && !$add)
                        <div class="btn-group">
                            <button type="button" id="backBtnSecond" onclick="goBack();" href="javascript:void(0);" title="Go Back"  class="btn btn-light no-border dropdown-toggle font-16 ds-c4 asBtn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="display: none;float: right;box-shadow: none;"><i class="fas fa-download ds-c4"></i></button>

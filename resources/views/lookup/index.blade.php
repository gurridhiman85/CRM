                                        ...
                                        <div class="form-body">
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="Tag" class="form-control form-control-sm" id="tag-filter" data-placeholder="Select Values" multiple="multiple">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="Productcat1_Des" id="Productcat1_Des-filter" class="form-control form-control-sm" multiple="multiple" data-placeholder="Select Values">
                                                        @foreach($Productcat1_Des as $AC1)
                                                            <option value="{!! $AC1 !!}">{!! $AC1 !!}</option>
                                                        @endforeach
                                                    </select>

                                                    <!--<input type="text" name="Productcat1" onkeyup="applyFilters();" class="form-control form-control-sm" placeholder="Enter search string" data-placeholder="">-->
                                                </div>

                                                <div class="form-group">
                                                    <label class="control-label">Activity Cat 2</label>
                                                    <select name="Productcat2_Des" id="Productcat2_Des-filter" class="form-control form-control-sm" multiple="multiple" data-placeholder="Select Values">
                                                        @foreach($Productcat2_Des as $AC2)
                                                            <option value="{!! $AC2 !!}">{!! $AC2 !!}</option>
                                                        @endforeach
                                                    </select>
                                                    <!--<input type="text" name="Productcat2" onkeyup="applyFilters();" class="form-control form-control-sm" placeholder="Enter search string" data-placeholder="">-->
                                                </div>

                                                <div class="form-group">
                                                    <label class="control-label">Activity</label>
                                                    <select name="Product" id="Product-filter" class="form-control form-control-sm" multiple="multiple" data-placeholder="Select Values">
                                                        @foreach($Product as $AT)
                                                            <option value="{!! $AT->ProdB !!}">{!! $AT->ProdB !!}</option>
                                                        @endforeach
                                                    </select>
                                                    <!--<input type="text" name="Product" onkeyup="applyFilters();" class="form-control form-control-sm" placeholder="Enter search string" data-placeholder="">-->
                                                </div>

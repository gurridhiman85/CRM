                                        ...
                                        <div class="form-body">
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <!--<input type="text" name="Productcat1_Des" onkeyup="applyFilters();" class="form-control form-control-sm" placeholder="Enter search string" data-placeholder="">-->
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <!--<input type="text" name="Productcat2_Des" onkeyup="applyFilters();" class="form-control form-control-sm" placeholder="Enter search string" data-placeholder="">-->
                                                </div>

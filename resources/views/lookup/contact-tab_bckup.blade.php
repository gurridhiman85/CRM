...
font-weight: 500;padding: 3px 4px !important;">Name and
                Address</div>
        ...
        <div class="divTableRow">
            <div class="divTableCell">
                <label class="l1">Contact ID</label>
            </div>
            <div class="divTableCell">
            ...
            <div class="divTableCell">
                <label class="l1">Household ID</label>
            </div>
            <div class="divTableCell">
                <div class="input t8 p2 dis txtds_mkc_householdid form-control form-control-sm"></div>
            </div>
            <div class="divTableCell"><label class="l1">Extended Name</label></div>
            <div class="divTableCell">
        ...
        <div class="divTableRow">
            ...
            <div class="divTableCell">
                <label class="l1">Person 2 First Name</label>
            </div>
            <div class="divTableCell">
                <input type="text" class="t8 p2 txtfirstname2 form-control form-control-sm" name="firstname2">
            </div>
            <div class="divTableCell"><label class="l1">City</label></div>
            <div class="divTableCell"><input type="text"
                                             style=" font-size:10px; width:504px"
        ...
        <div class="divTableRow">
            <div class="divTableCell">
                <label class="l1">Middle Name</label>
            </div>
            <div class="divTableCell">
            ...
            <div class="divTableCell">
                <label class="l1">Person 2 Middle Name</label>
            </div>
            <div class="divTableCell">
                <input type="text" class="t8 p2 txtmiddlename2 form-control form-control-sm" name="middlename2">
            </div>
            <div class="divTableCell"><label class="l1">State</label></div>
            <div class="divTableCell">
                <input type="text"
                       style=" font-size:10px; width:504px"
        ...
        <div class="divTableRow">
            ...
            <div class="divTableCell">
                <label class="l1">Person 2 Last Name</label>
            </div>
            <div class="divTableCell">
                <input type="text" class="t8 p2 txtlastname2 form-control form-control-sm" name="lastname2">
            </div>
            <div class="divTableCell"><label class="l1">Zip</label></div>
            <div class="divTableCell"><input type="text"
                                             style=" font-size:10px; width:504px"
        ...
        <div class="divTableRow">
            ...
            <div class="divTableCell">
                <label class="l1">Person 2 Suffix</label>
            </div>
            <div class="divTableCell">
                <input type="text" class="t8 p2 txtsuffix2 form-control form-control-sm" name="suffix2">
            </div>
            <div class="divTableCell"><label class="l1">Country</label></div>
            <div class="divTableCell"><input type="text"
                                             style=" font-size:10px; width:504px"
        ...
        <div class="divTableRow">
            ...
            <div class="divTableCell"><label class="l1">Person 2 Gender</label></div>
            ...
            <div class="divTableCell"><label class="l1">Company Name</label></div>
            <div class="divTableCell"><input type="text"
                                             style=" font-size:10px; width:504px"
        ...
        <div class="divTableRow">
            <div class="divTableCell">
                <label class="l1">Job Title</label>
            </div>
            <div class="divTableCell">
            ...
            <div class="divTableCell">
                <label class="l1">ZSS Contacts in HH</label>
            </div>
            <div class="divTableCell">
            ...
            <div class="divTableCell">
                <label class="l1">Company Include</label>
            </div>
            <div class="divTableCell">
        ...
        <div class="divTableRow">
            ...
            <div class="divTableCell">
                <label class="l1">Person 2 DFLName</label>
            </div>
            <div class="divTableCell">
            ...
            <div class="divTableCell"><label class="l1">Address Quality</label></div>
            <div class="divTableCell">
                <input type="text"
                       style=" font-size:10px; width:504px"
...
font-weight: bold;padding: 3px 4px !important;">
        ...
        <div class="divTableRow">
            <div class="divTableCell" style="width: 14%;color: #357EC7;
font-weight: 500;padding: 3px 4px !important;">Contactability
            </div>
            <div class="divTableCell"></div>
            <div class="divTableCell"></div>
            <div class="divTableCell"></div>
        ...
        <div class="divTableRow">
            <div class="divTableCell">
                <label class="l1">Phone - Primary</label>
            </div>
            <div class="divTableCell">
            ...
            <div class="divTableCell">
                <label class="l1">Phone - Secondary</label>
            </div>
            <div class="divTableCell">
        ...
        <div class="divTableRow">
            <div class="divTableCell">
                <label class="l1">Email - Primary</label>
            </div>
            <div class="divTableCell">
            ...
            <div class="divTableCell">
                <label class="l1">Email - Secondary</label>
            </div>
            <div class="divTableCell">
...
font-weight: bold;padding: 3px 4px !important;">
        ...
        <div class="divTableRow">
            <div class="divTableCell" style="width: 14%;color: #357EC7;
font-weight: 500;padding: 3px 4px !important;">Last Touch
            </div>
            <div class="divTableCell"></div>
            <div class="divTableCell"></div>
            <div class="divTableCell"></div>
        ...
        <div class="divTableRow">
            <div class="divTableCell">
                <label class="l1">Status + Channel</label>
            </div>
            <div class="divTableCell">
            ...
            <div class="divTableCell">
                <label class="l1">Campaign + Date</label>
            </div>
            @php
            ...
            <div class="divTableCell"><label class="l1">Comments</label></div>
            <div class="divTableCell">
...
font-weight: bold;padding: 3px 4px !important;">
        ...
        <div class="divTableRow">
            <div class="divTableCell" style="width: 14%;color: #357EC7;
font-weight: 500;padding: 3px 4px !important;">Key Events & Segment
            </div>
            <div class="divTableCell"></div>
            <div class="divTableCell"></div>
            <div class="divTableCell"></div>
        ...
        <div class="divTableRow">
            <div class="divTableCell">
                <label class="l1">First Sesshin Date</label>
            </div>
            <div class="divTableCell">
            ...
            <div class="divTableCell">
                <label class="l1">Jukai Date</label>
            </div>
            <div class="divTableCell">
                <div class="input-group" style="width: 95% !important;">
            ...
            <div class="divTableCell">
                <label class="l1">Ordainment Date</label>
            </div>
            <div class="divTableCell">
                <div class="input-group">
        ...
        <div class="divTableRow">
            ...
            <div class="divTableCell">
                <label class="l1">ZSS Segment</label>
            </div>
            <div class="divTableCell">
        ...
        <div class="divTableRow">
            <div class="divTableCell">
                <label class="l1">Donor Segment</label>
            </div>
            <div class="divTableCell">
            ...
            <div class="divTableCell">
                <label class="l1">Event Segment</label>
            </div>
            <div class="divTableCell">

                <input type="text" class="t8 dis txteventsegment form-control form-control-sm" name="eventsegment">
            </div>
            <div class="divTableCell"><label class="l1">Lifecyle Segment</label></div>
            <div class="divTableCell">
...
font-weight: bold;padding: 3px 4px !important;">
        ...
        <div class="divTableRow" style="height: 14px !important;">
            <div class="divTableCell" style="width: 14%;color: #357EC7;
font-weight: 500;padding: 3px 4px !important;">Notes
            </div>
            <div class="divTableCell"></div>
            <div class="divTableCell"></div>
            <div class="divTableCell"></div>
...
<div class="divTable">
    ...
    padding: 3px 0px !important;"><label class="l1">Additional Information</label>
            </div>

...
/*    $sSql = "SELECT count(*) as cnt FROM UL_RepCmp_Share WHERE User_id = '".$uid."' AND camp_tmpl_id = '".$record->row_id."' AND t_type = 'A'";
    ...
    */?>
    ...
    <td class="text-center">
        ...
        $ListXLSX = isset($rpschstatusmap[0]['file_name']) ? $record->promoexpo_folder.'\\'.$prefix.'RPL_'.$rpschstatusmap[0]['file_name'].'.xlsx' : '';
        ?>
    ...
    <td class="text-center pl-0 pt-1">
        @php
            $ListPDF = isset($rpschstatusmap[0]['file_name']) ? $record->promoexpo_folder.'\\'.$prefix.'RPL_'.$rpschstatusmap[0]['file_name'].'.pdf' : '';
        @endphp
    ...
    <td class="text-center">
        @php
            $SummaryXLSX = isset($rpschstatusmap[0]['file_name']) ? $record->promoexpo_folder.'\\'.$prefix.'RPS_'.$rpschstatusmap[0]['file_name'].'.xlsx' : '';
        @endphp
    ...
    <td class="text-center pl-0 pt-1">
        @php
            $SummaryPDF = isset($rpschstatusmap[0]['file_name']) ? $record->promoexpo_folder.'\\'.$prefix.'RPS_'.$rpschstatusmap[0]['file_name'].'.pdf' : '';
        @endphp

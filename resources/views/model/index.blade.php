...
@section('content')
    <?php
    \App\Library\AssetLib::library('model');
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-2" style="border-bottom: 1px solid #dee2e6;">
                        <div class="col-md-8">
                            <ul class="nav nav-tabs customtab2 mt-2 border-bottom-0 font-14 tab-hash tab-ajax" role="tablist" data-href="model/get" data-method="post" data-default-tab="tab_2">
                                ...
                                <li class="nav-item list-report" style="border-bottom: 1px solid #dee2e6;">
                                    <a class="nav-link" data-toggle="tab" data-tabid="7" href="#tab_7" role="tab" aria-selected="true" onclick="filtertoggle(1,'SingleCamp')">
                                        <span class="hidden-sm-up"></span>
                                        <span class="hidden-xs-down">Model Evaluation</span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item create-new" style="display: none;border-bottom: 1px solid #dee2e6;">
                                    <a class="nav-link" data-toggle="tab" data-shouldblank="no" data-tabid="9" href="#tab_9" role="tab" aria-selected="true" onclick="filtertoggle(0,'')">
                                        <span class="hidden-sm-up"></span>
                                        <span class="hidden-xs-down">Score</span>
                                    </a>
                                </li>
                                <li class="nav-item create-new" style="display: none;border-bottom: 1px solid #dee2e6;">
                        ...
                        <div class="col-md-4" onclick="if($('[data-tabid=9]').hasClass('active') || $('[data-tabid=9]').hasClass('active')) { $('#showSqlBtn').toggle() }">
                            <div class="btn-toolbar pull-right" role="toolbar" aria-label="Toolbar with button groups">
                                <div class="input-group">
                                    ...
                                    <input autocomplete="new-password" type="text" id="filtersearch" class="form-control ajax-search search-btn" placeholder="Search" aria-label="Input group example" aria-describedby="btnGroupAddon" >
                                    ...
                                    <button type="button" style="display: none;" id="DownloadBtn" title="Download" class="btn btn-light border-right-0 font-12" onclick="downloadESDLink($(this))" data-href="model/edownload" data-tab="catalog" aria-expanded="false"><i class="fas fa-download ds-c"></i></button>
                    ...
                    <div class="modal-body p-1">
                        <div class="card mb-1">
                            <div class="card-body p-1">
                                <form id="filter_form" class=" filter-inner respo-filter-myticket" data-title="tickets" autocomplete="off">
                                    <div class="form-body">
                                        <div class="row">
                                            @php
    ...
    <script src="js/googlecharts.js?ver={{ time() }}"></script>

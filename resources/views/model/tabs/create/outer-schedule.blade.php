                                            ...
                                            <div class="row">
                                                <div class="col-md-5 pr-0">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <select class="form-control form-control-sm" id="cmbschduletype" name="cmbschduletype" onChange="showRA(this)">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <select id="SR_Attachment" class="form-control form-control-sm">
                                                                ...
                                                                <option selected value="both">List & Report</option>
                                                ...
                                                <div class="col-md-1">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="SFTP_Attachment" class="form-control form-control-sm">
                                                            <option value="onlylist">List Only</option>
                                                            <option value="onlyreport">Report Only</option>
                                                            <option value="both">List & Report</option>
                                                            <option value="none">None</option>
                                                        </select>
                                                    </div>
                                                </div>

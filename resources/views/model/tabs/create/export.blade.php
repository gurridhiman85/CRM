    ...
    <div class='yui-panel'>
        ...
        <div class='bd'>
            <div id='divPromoExport' style='overflow-y:auto;overflow-x:hidden;height:476px;'>
                <table>
                    <tr>
                        <td style='width:200px;' valign=top>Save to Model Score Table</td>
                        <td valign=top>
                    ...
                    <tr id="trFolder" style="display:none">
                        <td valign=top>Export File Location</td>
                        <td valign=top>
...
<script src="js/model_export.js?ver={{time()}}" type="application/javascript"></script>

<div class="dataTables_info " id="taskList_info" role="status" aria-live="polite">
    <div class="ticket-pagination">
        {!! \App\Helpers\Helper::pagination_v2($total_records,$records_per_page,$page,'metadata_tab',$position,count($records)) !!}
    </div>
</div>
...
<script>
    function pagination_v2(obj, type) {
        ...
        var url = 'campaign/get?show_entries=20&tabid=26&rtype=pagination&page=' + track_page;
    ...
    function load_contents_v2(track_page, type, url) {
        ...
        $.get(url, {'page': track_page, type: type,filters : filtersArr}, function (data) {
            ...
            $("#edetails_tab").html(data.html); //append data into #results element
            initJS($("#edetails_tab"));

...
?>
    <tr>
        ...
        <td>{!! !empty($ccschstatusmap['file_name']) ? $ccschstatusmap['file_name'] : $record->Scored_File_Name !!}</td>
        <td>
            @if(!empty($category))
        ...
        <td class="text-center">
            <select onchange='show_Create_library($(this))' class='form-control-sm'
                ...
                <option value='view,{!! $record->row_id !!},"{!! $record->Scored_File_Name !!}",{!! $record->t_id !!}'>View
                </option>
                <option value='new,{!! $record->row_id !!},"{!! $record->Scored_File_Name !!}",{!! $record->t_id !!}'>Save
                    As
                </option>

                <option value='run,{!! $record->row_id !!},"{!! $record->Scored_File_Name !!}",{!! $record->t_id !!}'>Run
                    Report
                </option>
                <option value='replica,{!! $record->row_id !!},"{!! $record->Scored_File_Name !!}",{!! $record->t_id !!}'>
                    Run List
                </option>
                <option value='schedule,{!! $record->row_id !!},"{!! $record->Scored_File_Name !!}",{!! $record->t_id !!}'>
                    Schedule
                </option>
                <option value='email,{!! $record->row_id !!},"{!! $record->Scored_File_Name !!}",{!! $record->t_id !!}'>
                    Email
                </option>
                <option value='share,{!! $record->row_id !!},"{!! $record->Scored_File_Name !!}",{!! $record->t_id !!}'>
                    Share
                </option>
                <option value='deleteolderversion,{!! $ccschstatusmap['row_id'] !!},"{!! $record->Scored_File_Name !!}",{!! $record->t_id !!}'>
                    Delete
                </option>

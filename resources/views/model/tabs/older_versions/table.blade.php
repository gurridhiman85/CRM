...
<table id="basic_table2" class="table table-bordered table-hover color-table lkp-table" data-message="No Model available">
    <thead>
        <tr>
            <th>ID</th>
            <th>Level</th>
    ...
    <tbody>
        @if(count($records) > 0)
            @foreach($records as $record)
                @include('campaign.tabs.older_versions.table-single-row')
            @endforeach
        @endif
    </tbody>
</table>

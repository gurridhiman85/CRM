...
<header>
    ...
    <span style="line-height: 0.4cm;text-align:center;margin-left:0.5cm;margin-bottom:0.2cm;font-weight:400;color:black;">{!! $header !!}</span><!--<hr class="class-1">-->
</header>
...
<footer>
    ...
    <span class="page-date">{!! $footer !!}</span>
     <span style="bottom: 0cm; left: 0cm; margin-right: 0.5cm;height: 2cm;color: #9ea0a0;line-height: 1.5cm;float:right;">{!! date('Y-m-d') !!}</span>

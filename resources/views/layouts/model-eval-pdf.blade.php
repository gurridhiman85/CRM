...
<header>
    ...
    <div style="line-height: 0.3cm;text-align:center;margin-left:0.5cm;margin-top:0.5cm;margin-bottom:0.6cm;font-weight:400;color:black;">
        {!! $header !!}
    </div>
    <div style="font-size: 15px;line-height: 0.5cm;text-align:center;margin-left:0.5cm;margin-bottom:1cm;font-weight:400;color:black;">
        {!! $subheader !!}
    </div>
    <div style="font-size: 20px;line-height: 0.8cm;text-align:center;margin-left:0.5cm;margin-bottom:0.5cm;font-weight:400;color:black;">
        {!! $subheader2 !!}
    </div>
</header>
...
<main>
    ...
    <div class="cimg" style="margin-top:3.5cm;">
        {!! $charthtml !!}
    </div>

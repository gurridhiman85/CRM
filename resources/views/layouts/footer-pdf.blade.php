...
<header>
    <img style="height: 1.8cm;line-height: 1.5cm;margin-left:0.5cm;margin-top:0.1cm;margin-bottom:0.1cm;float:left;" src="{!! url('/').'/img/logo1.jpg' !!}"></img>{!! $header !!}<img style="height: 0.6cm;line-height: 1.5cm;margin-right:0.5cm;margin-top:0.7cm;margin-bottom:0.25cm;float:right;width: 135px;" src="{!! url('/').'/img/crmlogo.png' !!}"></img>
</header>
...
<footer>
    ...
    {{--<span class="page-sel">
        <b>Selection :</b> (EventSegment  like  '%Visit in Last%') AND (ZSS_Segment  like  '%tier%') and (EventSegment  like  '%Visit in Last%') AND (ZSS_Segment  like  '%tier%') and (EventSegment  like  '%Visit in Last%') AND (ZSS_Segment  like  '%tier%')
    </span>

    <span class="page-inter">
        <b>Interpretation :</b> 63% of the 4,983 records are categorized as Tier9_Prospect.
    </span>--}}

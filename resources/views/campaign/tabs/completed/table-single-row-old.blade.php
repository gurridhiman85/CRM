   ...
   {{-- <td class="text-center">
    ...
    <td class="text-center">
        <select  onchange='show_Create_library($(this))' class='form-control-sm' style="border-color: #bfe6f6;text-align-last: center;">
            ...
            <option value='view,{!! $record->row_id !!},"{!! $record->Name !!}"'>View</option>
            <option value='new,{!! $record->row_id !!},"{!! $record->Name !!}"'>Save As</option>
            <option value='run,{!! $record->row_id !!},"{!! $record->Name !!}"'>Run Report</option>
            <option value='replica,{!! $record->row_id !!},"{!! $record->Name !!}"'>Run List</option>
            <option value='schedule,{!! $record->row_id !!},"{!! $record->Name !!}"'>Schedule</option>
            <option value='email,{!! $record->row_id !!},"{!! $record->Name !!}"'>Email</option>
            <option value='share,{!! $record->row_id !!},"{!! $record->Name !!}"'>Share</option>
            <option value='delete,{!! $record->row_id !!},"{!! $record->Name !!}"'>Delete</option>

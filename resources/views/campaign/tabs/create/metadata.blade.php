<div id="doc3" style='margin:0;margin-top:-5px'>
    <div class='yui-panel'>
        <div class='bd'>
            ...
            <div id="divRep" style="display:none"></div>
        </div>
        <div class='ft' style='text-align:right'>
            <span class="button-group">
                <span id="yui-gen9" class="yui-button yui-push-button">
                    <span class="first-child"><button type="button" class="btn btn-info" id='savebottom' onClick='nextMeta();'>Next</button></span>
                </span>
            </span>
        </div>
    </div>
...
<script src="js/metadata.js" type="application/javascript"></script>
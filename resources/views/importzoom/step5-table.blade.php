<table class="table table-bordered table-hover color-table lkp-table">
    ...
    @foreach($sStep2TableRows as $sStep2TableRow)
        <tr>
            ...
            <td>
                <div class="ui-widget">
                    <input class="form-control typeahead" id="{{ $sStep2TableRow['rowid'] }}" type="text" value="{{ $sStep2TableRow['dflname_Suggested'] }}" onkeyup="addAutoComplete($(this))">
                </div>

...
@section('content')
    <?php
    \App\Library\AssetLib::library('profile');
            ...
            <div class="card">
                <div class="card-body pt-2">
                    ...
                    <div class="row mb-2" style="border-bottom: 1px solid #dee2e6;">
                        <div class="col-md-8">
                            <ul class="nav nav-tabs customtab2 mt-2 border-bottom-0 font-14 tab-hash tab-ajax" role="tablist" data-href="profile/get" data-method="get" data-default-tab="tab_22">
                                ...
                                <li class="nav-item" style="display: none;border-bottom: 1px solid #dee2e6;">
                        ...
                        <div class="col-md-4" onclick="if($('[data-tabid=23]').hasClass('active') || $('[data-tabid=24]').hasClass('active')) { $('#showSqlBtn').toggle() }">
                            <div class="btn-toolbar pull-right" role="toolbar" aria-label="Toolbar with button groups">
                                <div class="input-group">
                                    ...
                                    <button type="button" class="btn btn-light font-12 mr-1" style="display: none;" title="PDF" id="profile_pdf" onclick="d_pdf(1);"><i class="font-16 fas fa-file-pdf" style="color: #e92639;"></i></button>
                                    <button type="button" class="btn btn-light font-12 mr-1" style="display: none;" title="XLSX" id="profile_xlsx" onclick="d_pdf(2);"><i class="font-16 fas fa-file-excel" style="color: #06b489;;"></i></button>

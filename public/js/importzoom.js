...
$(document).ready(function () {
    ...
    $('.continue').on('click',function () {
        ...
        if(nextStep == 3){
            ...
            if(localStorage.getItem('stepsCompleted') == 3) {
                $('#zoomstep3').submit();
            }
        }else if(nextStep == 5){
            ...
            if(localStorage.getItem('stepsCompleted') == 6) {
                $('#zoomstep6').submit();
            }
        }else if(nextStep == 8){
            if(localStorage.getItem('stepsCompleted') == 7) {
                $('#zoomstep7').submit();
            }
        }
    ...
    if ($docs_input_files.length) {
        $docs_input_files.fileinput({
            uploadUrl: 'importzoom/step1', //File upload call
        ...
        $docs_input_files.on('filebatchuploadsuccess', function(event, data) {
            ...
            if(R.success){
                ...
                if(!R.success){
                    ...
                    $('.kv-fileinput-error').html('<span class="pull-left">' + msg + '</span>').show();

                    setTimeout(function () {
                        $('.kv-fileinput-error').html('').hide();

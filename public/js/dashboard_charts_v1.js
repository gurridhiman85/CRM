...
$(document).ready(function(){
    ...
    ACFn.loadstickypopup = function (F, R) {
        ...
        if (R.type && R.type == 'standard') {
            ...
            $.each(R.Filters_Labels, function (i,col) {
                if(col.Filter1_Label != "") {
                    $('.Filter1').show();
                    $('.Filter1_Label').text(col.Filter1_Label);
                }
                else
                    $('.Filter1').hide();

                if(col.Filter2_Label != "") {
                    $('.Filter2').show();
                    $('.Filter2_Label').text(col.Filter2_Label);
                }
                else
                    $('.Filter2').hide();

                if(col.Filter3_Label != "") {
                    $('.Filter3').show();
                    $('.Filter3_Label').text(col.Filter3_Label);
                }
                else
                    $('.Filter3').hide();

                if(col.Filter4_Label != "") {
                    $('.Filter4').show();
                    $('.Filter4_Label').text(col.Filter4_Label);
                }
                else
                    $('.Filter4').hide();
            /*               Notes  */

        ...
        $.ajax({
            ...
            success: function (response) {
                if (response !== undefined) {
                    colStr = 'ModelBuildID,SegmentID,ModelScore,ModelDecile,ModelTier,' + response.columns;

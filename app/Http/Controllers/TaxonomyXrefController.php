...
class TaxonomyXrefController extends Controller
{
    public $db;
    public $prefix;
    ...
    public function index(){
        ...
        return view('taxonomy-xref.index',[
    ...
    public function getTaxonomy(Request $request,Ajax $ajax){
        ...
        if($rType == 'pagination'){
            $html = View::make('taxonomy-xref.tabs.level.table',$data)->render();
        }else {
            $html = View::make('taxonomy-xref.tabs.level.index', $data)->render();
        }

        $paginationhtml = View::make('taxonomy-xref.tabs.level.pagination-html',[
    ...
    public function download(Request $request,Ajax $ajax){
        ...
        $view = View::make('taxonomy-xref.xlsx',[
            'reqlevel' => $level,
            'records' => $results['records'],

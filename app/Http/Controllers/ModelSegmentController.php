...
class ModelSegmentController extends Controller
{
    public $schtasks_dir;
    public $schDir;
    public $phpPath;
    ...
    public function getAddsubVal(Request $request,Ajax $ajax){
        ...
        $record = App\Model\ModelScoreTemplate::where('row_id',$tempid)->first(['row_id','t_id','seg_def','seg_noLS','seg_method','seg_criteria','seg_selected_criteria','seg_grp_no'
            ,'seg_ctrl_grp_opt','seg_camp_grp_dtls','seg_camp_grp_proportion','seg_camp_grp_sel_cri','seg_sample','seg_filters_criteria','seg_filter_condition'

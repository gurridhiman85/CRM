...
class DashboardController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $chartLabels = DB::select("SELECT Filter1_Label,Filter2_Label,Filter3_Label,Filter4_Label, Notes1, Notes2, Notes3, Notes4  FROM ZChart_Links WHERE link = '".$request->segment(1)."'");
    ...
    public function getDashboardInfo(Request $request,Ajax $ajax){
        ...
        $chartFiltersLabels = DB::select("SELECT Filter1_Label,Filter2_Label,Filter3_Label,Filter4_Label, Notes1, Notes2, Notes3, Notes4 FROM ZChart_Links where Dashboard = '$filtertype'");
        $chartFiltersLabels = collect($chartFiltersLabels)->map(function($x){ return (array) $x; })->toArray();
        ...
        return $ajax->success()
            ...
            ->appendParam('Filters_Labels',$chartFiltersLabels)

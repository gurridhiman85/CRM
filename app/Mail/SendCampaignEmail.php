...
class SendCampaignEmail extends Mailable
{
    ...
    public function build()
    {
        try{
            ...
            $mail = $this->view('mails.campaign')->from('admin@crmsquare.com','CRM Square Administrator')->with(['recData' => $this->recData])->subject($this->recData->Sub);
            ...
            if($is_list_exist && in_array($this->recData->Email_Attachment,['onlylist','both'])){
            ...
            if(!empty($Report_Row) && $is_summary_existPDF && in_array($this->recData->Email_Attachment,['onlyreport','both'])){
            ...
            if(!empty($Report_Row) && $is_summary_existXLSX && in_array($this->recData->Email_Attachment,['onlylist','both'])){
